...
func TestGrantsAddCmd(t *testing.T) {
	...
	t.Run("force add grant for nonexistent user", func(t *testing.T) {
		ch := setup(t)
		err := Run(context.Background(), "grants", "add", "nonexistent", "destination", "--allow-missing")
		assert.NilError(t, err)
	...
	t.Run("force add grant for nonexistent group", func(t *testing.T) {
		ch := setup(t)
		err := Run(context.Background(), "grants", "add", "nonexistent", "destination", "--group", "--allow-missing")
		assert.NilError(t, err)
	...
	t.Run("force add grant for nonexistent destination", func(t *testing.T) {
		ch := setup(t)
		err := Run(context.Background(), "grants", "add", "existing@example.com", "nonexistent", "--allow-missing")
		assert.NilError(t, err)
	...
	t.Run("force add grant for nonexistent namespace", func(t *testing.T) {
		ch := setup(t)
		err := Run(context.Background(), "grants", "add", "existing@example.com", "the-destination.nonexistent", "--allow-missing")
		assert.NilError(t, err)
	...
	t.Run("force add grant for nonexistent role", func(t *testing.T) {
		ch := setup(t)
		err := Run(context.Background(), "grants", "add", "existing@example.com", "the-destination", "--role", "nonexistent", "--allow-missing")
		assert.NilError(t, err)
