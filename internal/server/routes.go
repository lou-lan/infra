...
func (s *Server) GenerateRoutes(promRegistry prometheus.Registerer) *gin.Engine {
	...
	get(a, authn, "/v1/identities", a.ListUsers)
	post(a, authn, "/v1/identities", a.CreateUser)
	get(a, authn, "/v1/identities/:id", a.GetUser)
	put(a, authn, "/v1/identities/:id", a.UpdateUser)
	delete(a, authn, "/v1/identities/:id", a.DeleteUser)
	get(a, authn, "/v1/identities/:id/groups", a.ListUserGroups)
	get(a, authn, "/v1/identities/:id/grants", a.ListUserGrants)
